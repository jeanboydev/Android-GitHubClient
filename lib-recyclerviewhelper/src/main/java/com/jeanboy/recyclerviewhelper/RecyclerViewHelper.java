...
public class RecyclerViewHelper {
    ...
    public void notifyItemMoved(int fromPosition, int toPosition) {
        if (helperAdapter != null) {
            helperAdapter.notifyItemMoved(helperAdapter.getHeaderCount() + fromPosition,
                    helperAdapter.getHeaderCount() + toPosition);
        }
    }

    public void notifyItemRangeChanged(int positionStart, int itemCount) {
        if (helperAdapter != null) {
            helperAdapter.notifyItemRangeChanged(helperAdapter.getHeaderCount() + positionStart,
                    helperAdapter.getHeaderCount() + itemCount);
        }
    }

    public void notifyItemRangeInserted(int positionStart, int itemCount) {
        if (helperAdapter != null) {
            helperAdapter.notifyItemRangeInserted(helperAdapter.getHeaderCount() + positionStart,
                    helperAdapter.getHeaderCount() + itemCount);
        }
    }
    ...
    public void notifyItemRangeRemoved(int positionStart, int itemCount) {
        if (helperAdapter != null) {
            helperAdapter.notifyItemRangeRemoved(helperAdapter.getHeaderCount() + positionStart,
                    helperAdapter.getHeaderCount() + itemCount);
        }
    }
